...
|---------------------------------------|-----------------------------------|---------------------------------------------------|
|**cli_edt_run_script_file**            |EDTCLI_SCRIPT_PATH                 |                                                   |
|**cli_edt_build**                      |                                   |Очищает и пересобирает все или некоторые проекты   |
|**cli_edt_cd**                         |                                   | отображает или изменяет текущий рабочий каталог   |
|**cli_edt_clean-up-source**            |CI_PROJECT_NAME, EDT_PATH_PROJECT  |Оптимизирует формат хранения данных проекта        |
|**cli_edt_delete**                     |                                   |Удаляет все или некоторые проекты                  |
...
|**cli_edt_project**                    |                                   |Выводит информацию по всем или по нескольким проектам   |
|**cli_edt_script**                     |                                   |Выводит список доступных скриптов, показывает информацию о скрипте, загружает один или несколько скриптов   |
|**cli_edt_sort-project**               |EDT_PATH_PROJECT                   |Сортирует объекты конфигурации в соответствии с настройками автоматической сортировки   |
|**cli_edt_uninstall-platform-support** |DB_VERSION                         |удаляет поддержку платформы «1С:Предприятие» указанной версии   |
|**cli_edt_validate**                   |PROJECT_LOG_DIR , EDT_PATH_PROJECT |Проверяет проект и выводит результат в .tsv-файл   |
|**cli_edt_version**                    |                                   |выводит версию 1С:EDT или список установленных компонентов с версиями или версию выбранного компонента   |
