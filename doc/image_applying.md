...
|**CLI_LIB_PATH**    |Путь к библиотеке общих скриптов <br> *По-умолчанию: /usr/local/sbin/*|
...
|**LOG_PATH_DIR**    |Путь к каталогу логирования проекта edt <br> *По-умолчанию: ${PROJECT_BULD_DIR}/log* |
